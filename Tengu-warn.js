/**
 * ============================================================================
 * Tengu-warn — Warning message templates
 * Version 2.26.0
...
window.TenguWarn = {
  ...
  get: function (useIndonesian) {
    ...
    const WARN_MESSAGES = [
      // --- Common warnings ---
      {
        group: useIndonesian ? "Peringatan umum" : "Common warnings",
        items: [
          // ------------------------------------------------------------------
          // Vandalism
          // ------------------------------------------------------------------
          {
            value: "vandalism",
            label: useIndonesian ? "Vandalisme" : "Vandalism",
          ...
          {
            value: "testediting",
            label: useIndonesian ? "Uji coba penyuntingan" : "Editing tests",
            buildNotice: function (target, extra) {
              const en = withExtra(
          ...
          // ------------------------------------------------------------------
          {
            value: "blanking",
            label: useIndonesian
              ? "Penghapusan konten / pengosongan halaman"
              : "Removal of content, blanking",
            buildNotice: function (target, extra) {
              const en = withExtra(
