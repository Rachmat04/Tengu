          ...
          // ------------------------------------------------------------------
          {
            ...
            buildNotice: function (target, extra, isFinal) {
              ...
              const bodyEn =
                ...
                `\n\nIf you believe this warning has been issued in error, please leave a message on my talk page. ` + `~`.repeat(4);
              const bodyId =
                ...
                `\n\nJika Anda merasa peringatan ini diberikan secara keliru, silakan tinggalkan pesan di halaman pembicaraan saya. ` + `~`.repeat(4);
          ...
          // ------------------------------------------------------------------
          {
            ...
            buildNotice: function (target, extra, isFinal) {
              ...
              const bodyEn =
                ...
                (isFinal ? finalSentence(false) : "") +
                `\n\nIf you believe this notice has been issued in error, please leave a message on my talk page. ` + `~`.repeat(4);
              const bodyId =
                ...
                (isFinal ? finalSentence(true) : "") +
                `\n\nJika Anda merasa pemberitahuan ini diberikan secara keliru, silakan tinggalkan pesan di halaman pembicaraan saya. ` + `~`.repeat(4);
              const en = withExtra(headingEn + "\n" + bodyEn, extra, false);
              const id = withExtra(headingId + "\n" + bodyId, extra, true);
              return useIndonesian ? id : en;
            },
